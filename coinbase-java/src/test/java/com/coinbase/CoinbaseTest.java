...
//@PrepareForTest(com.coinbase.Coinbase.class)
public class CoinbaseTest {

//    private HttpsURLConnection mockConnection;
//    private URL mockURL;
//    private com.coinbase.Coinbase cb;
//
//    @Before
...
//        assertTrue(p1.allowBuy());
//        assertTrue(p1.allowSell());
//
//        assertFalse(p2.allowBuy());
//        assertFalse(p2.allowSell());
//    }
//
//    @Test
...
//        assertEquals("54630e62f1096f083e000002", cache.getPaymentMethod().getAccount().getId());
//
//    }
//
//    @Test
