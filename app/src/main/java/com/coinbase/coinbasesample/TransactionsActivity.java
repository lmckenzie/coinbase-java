...
public class TransactionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coinbase.getAccounts(new HashMap<String, Object>(), new CallbackWithRetrofit<Accounts>() {
            @Override
    ...
    private void getTransactions() {
        Coinbase coinbase = ((MainApplication)getApplicationContext()).getClient();
        coinbase.getTransactions(account.getId(), new HashMap<String, Object>(), new ArrayList<String>(), new CallbackWithRetrofit<Transactions>() {
            @Override
